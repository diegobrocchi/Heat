@ModelType Heat.ViewModels.invoices.AddNewProductInvoiceRowViewModel
@Code
    ViewData("Title") = "Aggiungi una nuova riga prodotto al documento"
    Dim languageCodeCLDR As String = Culture.Substring(0, 2)

End Code

<h2>Immissione di una nuova riga prodotto per la fattura</h2>
