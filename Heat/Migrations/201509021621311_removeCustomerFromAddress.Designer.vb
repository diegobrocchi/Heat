...
Namespace Migrations
    ...
    Public NotInheritable Partial Class removeCustomerFromAddress
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(removeCustomerFromAddress))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509021621311_removeCustomerFromAddress"
            End Get
        End Property
