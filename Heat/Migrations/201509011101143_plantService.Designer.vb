...
Namespace Migrations
    ...
    Public NotInheritable Partial Class plantService
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(plantService))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509011101143_plantService"
            End Get
        End Property
