...
Namespace Migrations
    ...
    Public NotInheritable Partial Class add_heaters
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(add_heaters))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509010733216_add_heaters"
            End Get
        End Property
