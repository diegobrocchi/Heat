...
Namespace Migrations
    ...
    Public NotInheritable Partial Class renameDistrictInAddress
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(renameDistrictInAddress))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509021627168_renameDistrictInAddress"
            End Get
        End Property
