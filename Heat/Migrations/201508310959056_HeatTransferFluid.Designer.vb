...
Namespace Migrations
    ...
    Public NotInheritable Partial Class HeatTransferFluid
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(HeatTransferFluid))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201508310959056_HeatTransferFluid"
            End Get
        End Property
