...
Namespace Migrations
    ...
    Public NotInheritable Partial Class BoilerHeater_CertificationReference
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(BoilerHeater_CertificationReference))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201508291936347_BoilerHeater_CertificationReference"
            End Get
        End Property
