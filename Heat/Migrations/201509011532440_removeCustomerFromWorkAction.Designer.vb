...
Namespace Migrations
    ...
    Public NotInheritable Partial Class removeCustomerFromWorkAction
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(removeCustomerFromWorkAction))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509011532440_removeCustomerFromWorkAction"
            End Get
        End Property
