...
Namespace Migrations
    ...
    Public NotInheritable Partial Class rename_filenameMedium
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(rename_filenameMedium))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509261312561_rename_filenameMedium"
            End Get
        End Property
