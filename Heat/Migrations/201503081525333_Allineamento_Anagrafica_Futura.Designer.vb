...
Namespace Migrations
    ...
    Public NotInheritable Partial Class Allineamento_Anagrafica_Futura
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Allineamento_Anagrafica_Futura))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201503081525333_Allineamento_Anagrafica_Futura"
            End Get
        End Property
