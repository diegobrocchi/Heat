...
Namespace Migrations
    ...
    Public NotInheritable Partial Class removeTelephoneFromPlant
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(removeTelephoneFromPlant))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509021730503_removeTelephoneFromPlant"
            End Get
        End Property
