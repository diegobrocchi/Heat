...
Namespace Migrations
    ...
    Public NotInheritable Partial Class PlantClassType
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(PlantClassType))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509021738570_PlantClassType"
            End Get
        End Property
