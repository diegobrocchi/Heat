...
Namespace Migrations
    ...
    Public NotInheritable Partial Class nullableLastServiceDateInPlantService
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(nullableLastServiceDateInPlantService))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509011245507_nullableLastServiceDateInPlantService"
            End Get
        End Property
