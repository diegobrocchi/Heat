...
Namespace Migrations
    ...
    Public NotInheritable Partial Class removePlantIdFromPlant
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(removePlantIdFromPlant))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509031007328_removePlantIdFromPlant"
            End Get
        End Property
