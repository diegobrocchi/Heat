...
Namespace Migrations
    ...
    Public NotInheritable Partial Class customer_notes
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(customer_notes))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509211856188_customer_notes"
            End Get
        End Property
