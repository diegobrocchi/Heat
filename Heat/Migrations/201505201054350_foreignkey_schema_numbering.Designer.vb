...
Namespace Migrations
    ...
    Public NotInheritable Partial Class foreignkey_schema_numbering
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(foreignkey_schema_numbering))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201505201054350_foreignkey_schema_numbering"
            End Get
        End Property
