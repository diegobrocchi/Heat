...
Namespace Migrations
    ...
    Public NotInheritable Partial Class distinctCodePlant
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(distinctCodePlant))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509021757191_distinctCodePlant"
            End Get
        End Property
