...
Namespace Migrations
    ...
    Public NotInheritable Partial Class removePhoneFromAddress
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(removePhoneFromAddress))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509021628240_removePhoneFromAddress"
            End Get
        End Property
