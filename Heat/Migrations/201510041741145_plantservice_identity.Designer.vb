...
Namespace Migrations
    ...
    Public NotInheritable Partial Class plantservice_identity
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(plantservice_identity))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201510041741145_plantservice_identity"
            End Get
        End Property
