...
Namespace Migrations
    ...
    Public NotInheritable Partial Class changeWorkAction1
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(changeWorkAction1))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201508271044009_changeWorkAction1"
            End Get
        End Property
