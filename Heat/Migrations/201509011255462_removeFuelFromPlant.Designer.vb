...
Namespace Migrations
    ...
    Public NotInheritable Partial Class removeFuelFromPlant
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(removeFuelFromPlant))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509011255462_removeFuelFromPlant"
            End Get
        End Property
