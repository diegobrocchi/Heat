...
Namespace Migrations
    ...
    Public NotInheritable Partial Class removeAddressPlant
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(removeAddressPlant))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509021416399_removeAddressPlant"
            End Get
        End Property
