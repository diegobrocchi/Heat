...
Namespace Migrations
    ...
    Public NotInheritable Partial Class plantidToPlantservice
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(plantidToPlantservice))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201509011212463_plantidToPlantservice"
            End Get
        End Property
