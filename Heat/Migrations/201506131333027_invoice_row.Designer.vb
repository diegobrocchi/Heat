...
Namespace Migrations
    ...
    Public NotInheritable Partial Class invoice_row
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(invoice_row))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201506131333027_invoice_row"
            End Get
        End Property
