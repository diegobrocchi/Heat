...
Namespace Migrations
    ...
    Public NotInheritable Partial Class proposedCalls
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(proposedCalls))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201510071958419_proposedCalls"
            End Get
        End Property
