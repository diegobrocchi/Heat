...
Namespace Migrations
    ...
    Public NotInheritable Partial Class foreignkey_warehouse
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(foreignkey_warehouse))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201505231212567_foreignkey_warehouse"
            End Get
        End Property
