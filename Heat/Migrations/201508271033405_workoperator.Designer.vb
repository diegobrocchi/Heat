...
Namespace Migrations
    ...
    Public NotInheritable Partial Class workoperator
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(workoperator))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201508271033405_workoperator"
            End Get
        End Property
