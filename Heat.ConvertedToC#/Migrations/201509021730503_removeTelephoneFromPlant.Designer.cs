...
namespace Heat.Migrations
{
	...
	public sealed partial class removeTelephoneFromPlant : IMigrationMetadata
	{

		private readonly ResourceManager Resources = new ResourceManager(typeof(removeTelephoneFromPlant));

		private string IMigrationMetadata_Id {
			get { return "201509021730503_removeTelephoneFromPlant"; }
		}
