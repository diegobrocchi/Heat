...
namespace Heat.Migrations
{
	...
	public sealed partial class removeFuelFromPlant : IMigrationMetadata
	{

		private readonly ResourceManager Resources = new ResourceManager(typeof(removeFuelFromPlant));

		private string IMigrationMetadata_Id {
			get { return "201509011255462_removeFuelFromPlant"; }
		}
