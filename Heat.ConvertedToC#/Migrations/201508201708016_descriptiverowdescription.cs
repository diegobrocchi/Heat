...
{
	public partial class descriptiverowdescription : DbMigration
	{
		...
		public override void Up()
		{
			...
			AddColumn("dbo.InvoiceRows", "RowDescription", c => c.String());
		}
		...
		public override void Down()
		{
			...
			AddColumn("dbo.InvoiceRows", "Description", c => c.String());
		}
	}
}
