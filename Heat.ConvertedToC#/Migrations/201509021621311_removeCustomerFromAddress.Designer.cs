...
namespace Heat.Migrations
{
	...
	public sealed partial class removeCustomerFromAddress : IMigrationMetadata
	{

		private readonly ResourceManager Resources = new ResourceManager(typeof(removeCustomerFromAddress));

		private string IMigrationMetadata_Id {
			get { return "201509021621311_removeCustomerFromAddress"; }
		}
